...
RESULTS_TASK_2 = Path("result/results task 2")
DISTORTION_RESTORATION_CSV = (
    RESULTS_TASK_2 / "cnn_on_distortion_restoration" / "confusion_percentages.csv"
)
BASIC_METRICS_PATH = RESULTS_TASK_2 / "cnn_on_basic" / "metrics.txt"
FINE_TUNE_CSV = RESULTS_TASK_2 / "cnn_fine_tune_distortion" / "summary.csv"
OUTPUT_PATH = (
    RESULTS_TASK_2
...
def main() -> None:
    ...
    print("Saved comparison graphs to:", RESULTS_TASK_2)
