...
OUTPUT_DIR = Path("result/results task 2/super_resolution_snr")
...
def main() -> None:
    ...
    print("Saved Task 2 SNR super-resolution results to:", OUTPUT_DIR.resolve())
