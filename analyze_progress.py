...
plt.tight_layout()
plt.savefig('results/results_augmented/yolo_detection_progress.png', dpi=150, bbox_inches='tight')
print("✅ Graph saved to: results/results_augmented/yolo_detection_progress.png")
